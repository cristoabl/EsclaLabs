      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-24 flex flex-col md:flex-row justify-between items-end gap-10">
           <div>
              ...
              <h2 className="text-6xl md:text-8xl font-black leading-[0.8] tracking-tightest uppercase italic text-white">Soluciones <br /> <span className="text-white/10">Modulares.</span></h2>
           </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="group relative h-[500px] rounded-[3rem] overflow-hidden border border-white/5 bg-neutral-950 transition-all hover:border-cyan-500/30">
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-cyan-500 selection:text-black cursor-none overflow-x-hidden font-sans">
      ...
      <style jsx global>{`
        ...
        .italic-shadow { text-shadow: 10px 10px 0px rgba(6, 182, 212, 0.1); }
